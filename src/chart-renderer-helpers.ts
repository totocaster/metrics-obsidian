...
export function displayPanel(panel: MetricsChartPanel, state: PanelInteractionState): MetricsChartPanel {
...
export function colorClassBySeriesKey(panel: MetricsChartPanel): Map<string, string> {
...
export function appendBarChartGuideOverlay(
  svg: SVGSVGElement,
  panel: MetricsChartPanel,
  plotWidth: number,
  yForValue: (value: number) => number,
...
export function appendXAxisLabels(
  svg: SVGSVGElement,
...
export function lineHoverTargets(
  panel: MetricsChartPanel,
...
export function barHoverTargets(
  panel: MetricsChartPanel,
  bucketWidth: number,
  visibleKeys: Set<string>,
  colorClasses: Map<string, string>,
...
export function attachHoverTargets(
  panelEl: HTMLElement,
  svg: SVGSVGElement,
  panel: MetricsChartPanel,
  targets: HoverTarget[],
...
export function chartPanelTitle(panel: MetricsChartPanel): string {
